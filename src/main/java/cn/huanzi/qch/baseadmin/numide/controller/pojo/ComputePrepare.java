...
public class ComputePrepare {
    ...
    public void computeSum(){
        this.sum = (double) 1;
        if (this.getPhe()!=null){
            this.sum *= (double) this.getPhe();
        }
        if(this.getXyl()!=null){
            this.sum *= (double) this.getXyl();
        }
        if (this.getRaf()!=null){
            this.sum *= (double) this.getRaf();
        }
        if(this.getInd()!=null){
            this.sum *= (double) this.getInd();
        }
        if (this.getSuc()!=null){
            this.sum *= (double) this.getSuc();
        }
        if (this.getOrn()!=null){
            this.sum *= (double) this.getOrn();
        }
        if (this.getLac()!=null){
            this.sum *= (double) this.getLac();
        }
        if (this.getONPG()!=null){
            this.sum *= (double) this.getONPG();
        }
        if (this.getUre()!=null){
            this.sum *= (double) this.getUre();
        }
        if(this.getCit()!=null){
            this.sum *= (double) this.getCit();
        }
        if (this.getMalt()!=null){
            this.sum *= (double) this.getMalt();
        }
        if (this.getLac()!=null){
            this.sum *= (double) this.getLac();
        }
